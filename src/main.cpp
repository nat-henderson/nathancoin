...
uint256 hashGenesisBlock("0xa7703dee9dfbad5cedf66d210159ad3dafd12964b15cc0ca2b20db7d65d27494");
...
const string strMessageMagic = "NathanCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // NathanCoin: 1 day to retarget
static const int64 nTargetSpacing = 60; // NathanCoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nathancoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NathanCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1515219306; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1216464;

        if (fTestNet)
        {
            block.nTime    = 1515219306;
            block.nNonce   = 0;
        }
        ...
        {
           return error("Oh no, the genesis block doesn't make sense!") ;
        }
